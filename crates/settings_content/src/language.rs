...
pub struct LanguageSettingsContent {
    ...
    /// Controls how bracket colors are derived from the theme accents.
    ///
    /// - "auto": Reorder the theme accents when adjacent bracket contrast is weak
    /// - "theme": Preserve the theme-provided accent order exactly
    ///
    /// Default: auto
